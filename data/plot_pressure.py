...
for dir_name in os.listdir('.'):
    if os.path.isdir(dir_name):
        ...
        try:
            d = re.search(r'N=16384_L=8_D=([\d.]+)_T=1_MASS=200_N_TEST=1_T_STEP=([\d.]+)_N_STEP=10000_bounded=true', dir_name).group(1)
...
plt.legend()
plt.savefig('pressure_N=16384_L=8_N_STEP=10000_bounded=true.png')
plt.clf()
...
plt.ylabel('Pressure')
plt.legend()
plt.savefig('pressures_N=16384_L=8_N_STEP=10000_bounded=true.png')
